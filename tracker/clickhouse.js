...
function toRow(payload) {
  ...
  return {
    ...
    attribution:     JSON.stringify(payload.attribution || {}),

    ft_utm_source:   ft.utm_source   || null,
    ft_utm_medium:   ft.utm_medium   || null,
    ft_utm_campaign: ft.utm_campaign || null,
    ft_utm_term:     ft.utm_term     || null,
    ft_utm_content:  ft.utm_content  || null,
    ft_fbclid:       ft.fbclid       || null,
    ft_gclid:        ft.gclid        || null,
    ft_ttclid:       ft.ttclid       || null,
    ft_msclkid:      ft.msclkid      || null,
    ft_twclid:       ft.twclid       || null,
    ft_dclid:        ft.dclid        || null,
    ft_gbraid:       ft.gbraid       || null,
    ft_wbraid:       ft.wbraid       || null,
    ft_yclid:        ft.yclid        || null,

    lt_utm_source:   lt.utm_source   || null,
    lt_utm_medium:   lt.utm_medium   || null,
    lt_utm_campaign: lt.utm_campaign || null,
    lt_utm_term:     lt.utm_term     || null,
    lt_utm_content:  lt.utm_content  || null,
    lt_fbclid:       lt.fbclid       || null,
    lt_gclid:        lt.gclid        || null,
    lt_ttclid:       lt.ttclid       || null,
    lt_msclkid:      lt.msclkid      || null,
    lt_twclid:       lt.twclid       || null,
    lt_dclid:        lt.dclid        || null,
    lt_gbraid:       lt.gbraid       || null,
    lt_wbraid:       lt.wbraid       || null,
    lt_yclid:        lt.yclid        || null,
